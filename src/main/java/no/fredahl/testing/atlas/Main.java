package no.fredahl.testing.atlas;
...
public class Main implements Application {
    ...
    public void start(Window window) throws Exception {
        ...
        Image image = new Image(FileUtility.resource.toBuffer("testing/atlas/biome_tundra.png",1024),false);
        texture.bind();
        texture.wrapST(GL_REPEAT);
        texture.filter(GL_NEAREST);
        texture.tex2D(image);
        image.free();
        atlas = new TextureAtlas(texture,FileUtility.resource.asLines("testing/atlas/biome_tundra.atlas"));
        ...
        String vs_source = FileUtility.resource.toString("testing/atlas/vertex.glsl");
        String fs_source = FileUtility.resource.toString("testing/atlas/fragment.glsl");

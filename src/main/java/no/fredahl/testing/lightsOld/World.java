...
public class World {
    ...
    public World() throws Exception {
        ...
        Mesh heightmapMesh = Assets.get().heightmapMesh(Assets.HEIGHTMAP_PNG,0.055f,1);
        ...
        for (int i = -1; i <= 1; i++) {
            for (int j = -1; j <= 1; j++) {
                ...
                heightmapTransform.setPosition(scale * i,-5,scale * j);
        ...
        PointLight pointLight2 = new PointLight(new Vector3f(0.5f,0.4f,0.4f),new Vector3f(20f,2f,20f));
        ...
        SpotLight spotLight = new SpotLight(pointLight1,new Vector3f(0,-1,0.0001f).normalize(),70f,90f);

...
public class Voxels implements Disposable {
    ...
    public Voxels(int batchSizeQuads) throws Exception {
        ...
        String vs_source = FileUtility.resource.toString("testing/voxels/voxel/vertex.glsl");
        String fs_source = FileUtility.resource.toString("testing/voxels/voxel/fragment.glsl");

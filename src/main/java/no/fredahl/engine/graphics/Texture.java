...
import static no.fredahl.engine.graphics.Texture.Config.LINEAR_REPEAT;
...
public class Texture {
    ...
    public Texture(int[] rgba, int width, int height) {
        this(rgba,width,height,LINEAR_REPEAT);
    }
    ...
    public enum Config {
        ...
        LINEAR_REPEAT(new DefaultConfig()), // OpenGL Default
        NEAREST_REPEAT(new DefaultConfig(GL_TEXTURE_2D,GL_UNSIGNED_BYTE,GL_REPEAT,GL_NEAREST)),
        ;
        ...
        private static final class DefaultConfig implements TextureConfig {
            ...
            public DefaultConfig(float lod) {
                this(GL_TEXTURE_2D, lod);
            }

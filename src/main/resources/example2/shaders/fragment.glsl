...
{
    // no need to normalize light.direction here for gods sake, i do it in java
...
vec4 calcPointLight(PointLight light, vec3 position, vec3 normal)
{
    ...
    // Specular Light
    vec3 camera_direction = normalize(-position); // i think we already have this in orbital cam java
...
void main()
{
    ...
    // todo: if distance < some outer limit
